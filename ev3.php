              ...
              <div class="row">
                ...
                <div class="col-lg-8 entries">
                  ...
                  <article class="entry entry-single">
                    ...
                    <div class="entry-img">
                      <img src="assets/img/event/e3.jpg" alt="" class="img-fluid">
                    </div>
      
                    <h2 class="entry-title">
                      <a>Réussir Votre PFE</a>
                    </h2>
      
                    <div class="entry-meta">
                      <ul>
                        <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a>Admin</a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a><time>7 mai 2022</time></a></li>
                      </ul>
                    </div>
      
                    <div class="entry-content">
                      <p>
                        𝐈𝐧𝐬𝐜𝐫𝐢𝐯𝐞𝐳-𝐯𝐨𝐮𝐬 et assurez votre préparation pour les projets fin d'études en gagnant les compétences nécessaires ce samedi 19H
                        Via Google meet !
                      </p>
                      ...
                      <blockquote>
                        <p>
                            ...
                            <br>
                            <a href="https://l.facebook.com/l.php?u=https%3A%2F%2Fforms.gle%2FZoX5LgtFiSphCyUr9%3Ffbclid%3DIwAR3mVvrtHIp9gLYl4KXcVB_RtSbpq9I2Yysv7ZIXySdmDC7xYf4jyqFBsPQ&h=AT33YjQxPec-9EBr60SVlRC_IRzd2YFFDNqZD29Rm1BbIbISoEvCOSCnF_PulNpB0JBD1_wLZZi3eyqRDivHtX1c_-dtz-reFCgvuP1fPw1yPdeaI599Halr37E7E3POlNqa&__tn__=-UK*F">Lien d'inscription</a>
                        </p>
                      </blockquote>
                  </article>
                </div>
