          ...
          <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
              ...
              <div class="section-title">
                <h2>4C : Centres de Carrières et de Certifications des Compétences :</h2>
                <span>
                    ...
                    pour plus d'informations voir notre page facebook :
                </span>
                </div>
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="member" data-aos="fade-up" data-aos-delay="100">
                    <div class="pic"><img src="assets/img/4c.jpg" class="img-fluid" alt=""></div>
                    <div class="member-info">
                      <h4>4C</h4>
                      <div class="social">
                        <a href="https://www.facebook.com/4cisikef"><i class="bi bi-facebook"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
