                  ...
                  <div class="row">
                    <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                      <div class="blog_entry">
                        <a href="#"><img src="assets/img/event/e4.jpg" alt="e4" class="img-fluid"></a>
                        <div class="p-4 bg-white">
                          <h3><a href="#">Candidatez dés aujourd'hui !</a></h3>
                          <span class="date">17 février 2022</span>
                          <p>lancement du programme entrepreneuriat du centre Elife Kef ...</p>
                    ...
                    <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                      <div class="blog_entry">
                        <a href="#"><img src="assets/img/event/e5.jpg" alt="e5" class="img-fluid"></a>
                        <div class="p-4 bg-white">
                          <h3><a href="#">Session d'information</a></h3>
                          <span class="date">16 février 2022</span>
                          <p>اليوم الإعلامي للمركز التّكنولوجي إليف بالمعهد العالي للإعلاميّة بالكاف</p>
                          <p class="more"><a href="#">En savoir plus ...</a></p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                      <div class="blog_entry">
                        <a href="#"><img src="assets/img/event/e6.jpg" alt="e6" class="img-fluid"></a>
                        <div class="p-4 bg-white">
                          <h3><a href="#">GDG RANDOTEK </a></h3>
                          <span class="date">12 février 2022 </span>
                          <p>ورشة عمل من تنظيم GDG BEJA بالشراكة مع UniThink Team و نادي GDG بالمعهد العالي للإعلامية بالكاف ...</p>
                          <p class="more"><a href="#">En savoir plus ...</a></p>
                        </div>
                      </div>
                    </div>
