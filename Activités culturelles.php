          ...
          <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
              ...
              <div class="section-title">
                <h2>A l’Institut Supérieur d’Informatique du Kef, on a 4 clubs :</h2>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="member" data-aos="fade-up" data-aos-delay="100">
                    <div class="pic"><img src="assets/img/club/gdsc.jpg" class="img-fluid" alt=""></div>
                    <div class="member-info">
                      <h4>Google Developer Student Club - ISI Kef</h4>
                      <div class="social">
                        <a href="https://twitter.com/GDSCISIKEF"><i class="bi bi-twitter"></i></a>
                        <a href="https://www.facebook.com/GDSCISIKEFF"><i class="bi bi-facebook"></i></a>
                        <a href="https://www.instagram.com/gdscisikef/"><i class="bi bi-instagram"></i></a>
                        <a href="https://www.linkedin.com/company/gdscisikef/"><i class="bi bi-linkedin"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <div class="member">
                    <div class="pic"><img src="assets/img/club/ant.jpg" class="img-fluid" alt=""></div>
                    <div class="member-info">
                      <h4>Club ANT ISIK</h4>
                      <div class="social">
                        <a href="https://www.facebook.com/ClubANTISIK/"><i class="bi bi-facebook"></i></a>
                        <a href="https://www.instagram.com/club_ant_isik/"><i class="bi bi-instagram"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                  <div class="member">
                    <div class="pic"><img src="assets/img/club/ena.jpg" class="img-fluid" alt=""></div>
                    <div class="member-info">
                      <h4>Enactus Institut Supérieur d'informatique kef</h4>
                      <div class="social">
                        <a href="https://www.facebook.com/Enactus-Institut-Sup%C3%A9rieur-dinformatique-kef-105005605792357"><i class="bi bi-facebook"></i></a>
                        <a href="instagram.com/enactus_isikef/"><i class="bi bi-instagram"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                  <div class="member">
                    <div class="pic"><img src="assets/img/club/rotara.jpg" class="img-fluid" alt=""></div>
                    <div class="member-info">
                      <h4>Rotaract Club Sicca Le Kef</h4>
                      <div class="social">
                        <a href="https://www.facebook.com/RotaractClubSiccaLeKef"><i class="bi bi-facebook"></i></a>
                        <a href="https://www.instagram.com/rotaract_club_sicca_le_kef/"><i class="bi bi-instagram"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
