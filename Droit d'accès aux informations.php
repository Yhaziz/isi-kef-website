...
<br><br><br>
        ...
        <div class="breadcrumbs" data-aos="fade-in">
          <div class="container">
            <h1>Droit d'accès aux informations</h1>
          </div>
        </div>
          ...
          <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
              ...
              <div class="section-title">
                <h2> : حق النفاذ إلى المعلومة بالمعهد العالي للإعلاميّة بالكاف</h2>
                <h3> :سياسة النفاذ إلى المعلومة</h3>
              </div>
              <center>
                <div style="text-align: right;" dir="rtl">
                  ...
                  <span style="font-size: medium;"> </span>
                  <p dir="rtl"><span style="font-size: medium;"><a class="lien_document" title="منشور رئيس الحكومة عدد 19 المؤرخ في 18 ماي 2018.pdf" href="http://www.isikef.rnu.tn/Fr/image.php?id=2662" target="_blank">منشور رئيس الحكومة عدد 19 المؤرخ في 18 ماي 2018</a> والمتعلق بالحق في  النفاذ إلى المعلومة مطبوعات خاصة بالنفاذ  مطلب نفاذ إلى المعلومة.</span></p>
                  <span style="font-size: medium;"> </span>
                  <p dir="rtl"><span style="font-size: medium;">- <a class="lien_document" title="قائمة المكلّفين بالنّفاذ إلى المعلومة.pdf" href="http://www.isikef.rnu.tn/Fr/image.php?id=2665" target="_blank">قائمة المكلّفين بالنّفاذ إلى المعلومة.</a></span></p>
                  <span style="font-size: medium;"> </span> 
                  <ul>
                  <li><span style="font-size: medium;">وثائق للتحميل:</span></li>
                  </ul>
                  <span style="font-size: medium;"> </span><ol><span style="font-size: medium;"> </span>
                  <li><span style="font-size: medium;"><a class="lien_document" title="مطلب نفاذ إلى المعلومة.pdf" href="http://www.isikef.rnu.tn/Fr/image.php?id=2633" target="_blank">مطلب نفاذ إلى المعلومة</a></span></li>
                  <span style="font-size: medium;"> </span>
                  <li><span style="font-size: medium;"><a class="lien_document" title="مطلب تظلم لدى رئيس الهيكل.pdf" href="http://www.isikef.rnu.tn/Fr/image.php?id=2657" target="_blank">مطلب تظلم لدى رئيس الهيكل</a></span></li>
                  </ol></div>
            </center>
            </div>
          </section>
