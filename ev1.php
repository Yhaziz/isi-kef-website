              ...
              <div class="row">
                ...
                <div class="col-lg-8 entries">
                  ...
                  <article class="entry entry-single">
                    ...
                    <div class="entry-img">
                      <img src="assets/img/event/e1.jpg" alt="" class="img-fluid">
                    </div>
                    ...
                    <div class="entry-meta">
                      <ul>
                        ...
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a><time>18 octobre 2022</time></a></li>
                      </ul>
                    </div>
      
                    <div class="entry-content">
                      <p>
                        Qu'est-ce que le Projet Voltaire ? Le Projet Voltaire travaille avec les plus grands experts pour proposer des services en ligne de remise à niveau personnalisée en orthographe, pour une bonne expression écrite en milieu professionnel. Ces services sont utilisés par des particuliers, des écoles et des entreprises.
                      </p>
      
                      <blockquote>
                        <p>
                            l'évènement de demain à l'amphithéâtre à 12h pour les étudiants de 2-ème année LSI.
                            La présence est obligatoire
                        </p>
                      </blockquote>

                      <form action="php/commentadd.php" method="post">
                <label  for="comment">Comment:</label><br>
                <textarea id="comment" name="comment" required ></textarea><br>
                <button class="appointment-btn scrollto" type="submit" >Publish</button>
