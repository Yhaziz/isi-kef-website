              ...
              <div class="row">
                ...
                <div class="col-lg-8 entries">
                  ...
                  <article class="entry entry-single">
                    ...
                    <div class="entry-img">
                      <img src="assets/img/event/e2.jpg" alt="" class="img-fluid">
                    </div>
      
                    <h2 class="entry-title">
                      <a>The Enactus Tunisia</a>
                    </h2>
      
                    <div class="entry-meta">
                      <ul>
                        <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a>Admin</a></li>
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a><time>14 octobre 2022</time></a></li>
                      </ul>
                    </div>
                    ...
                    <div class="entry-content">
                      ...
                      <blockquote>
                        <p>
                            Chers étudiants du Kef ( ISI Kef, ISEAHK , INTSK, ESAK, ISSEPK, ISMTK, ISSIK, ISET Kef), Enactus Tunisia organisera le Mardi 18 Octobre 2022 à 09h30 à l'Institut Supérieur d'Informatique du Kef (ISI Kef) , son Road Show à la région du Kef. Ce Road Show, englobera un event ayant pour objectif d’attirer nos chers étudiants et apprenants pour qu’ils rejoignent leur réseau de ClUBS ENACTUS.
                            Ne ratez pas l'occasion et soyez au Rendez-Vous!!!
                        </p>
                      </blockquote>
                  </article>
                </div>
